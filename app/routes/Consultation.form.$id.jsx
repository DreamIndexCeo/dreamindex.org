...
export async function action({ request, params }) {
  ...
  if (formData) {
    if (id == "section1") {
      ...
      const auth = await prisma.codes.findMany({
        // Pulling the code query that matches the clients to see if its available
        where: {
          AccessCode: id_Key,
          Status: true,
        },
      ...
      if (auth.length) {
        //if auth pulled a valid query using the id_Key
        return { Data };
      } else {
      ...
      const updateUser = await prisma.codes.updateMany({
        // updating the code query to not be used again
        where: {
          AccessCode: id_Key,
        },
        data: {
      ...
      const createForm = await prisma.forms.create({
        // creating a new query for the uploaded form data
        data: {
          accessCode: id_Key,
          Name: fullName,
          Phone: phone,
      ...
      {section.id === "section2" && (
        <Form className="paymentFormContainer" method="post">
          ...
          <div className="inputwrap">
            <div class="inputGroup">
              <label class="inputLabel">
                <span style={{ color: "red" }}>*</span> Enter your desired
                website name:
              </label>
              <textarea
                autocomplete="off"
                name="Enter your desired
                website name"
                id="Question0"
                class="input"
                type="text"
            ...
            <div class="inputGroup">
              <label class="inputLabel">
                <span style={{ color: "red" }}>*</span> Describe your business
              ...
              <div class="inputGroup">
                ...
                <ul>
                  <li>
                    <input
                      type="radio"
                      name="What Category describes your website?"
                  ...
                  <li>
                    <input
                      type="radio"
                      name="What Category describes your website?"
                      value="Appointment Booking Website"
                    />
              ...
              <div class="inputGroup">
                ...
                <ul>
                  <li>
                    <input
                      type="radio"
                      name="Have you had a website in the past?"
                      value="Yes"
                    />
                    Yes
                  </li>
            ...
            <div class="inputGroup">
              <label class="inputLabel">
                <span style={{ color: "red" }}>* </span>Needed Features for you
                website:
              </label>
              <textarea
                autocomplete="off"
            ...
            <div class="inputGroup">
              <label class="inputLabel">How did you find us:</label>
              <input
                autocomplete="off"
            ...
            <div class="inputGroup">
              <label class="inputLabel">Enter Referral Code (optional):</label>
              <input
                autocomplete="off"
      ...
      {section.id === "section3" && (
        <Form className="paymentFormContainer" method="post">
          ...
          <div className="inputwrap">
            <div class="inputGroup">
              <label class="inputLabel">
                Desired Primary / Main Color of your website: ( Use color name
                or Hex Code or ColorPicker Box )
              </label>
            ...
            <div class="inputGroup">
              <label class="inputLabel">
                Desired Secndary Color of your website: ( Use color name or Hex
                Code or ColorPicker Box )
              </label>
            ...
            <div class="inputGroup">
              ...
              <ul>
                <li>
                  <input
                    type="radio"
                    name="Do you have images you can provide that will be used on our website"
                    value="Yes"
                  />
                  Yes
                </li>
                ...
                <li>
                  <input
                    type="radio"
                    name="Do you have images you can provide that will be used on our website"
                    value="Yes but need time to collect"
                  />
                ...
                <div class="radio-tile-group">
                  <div class="input-container">
                    <input
                      class="radio-button"
                      type="radio"
                      name="Desired time for your Meeting"
                      value="9:00am"
                    />
...
export function links() {
  return [
    ...
    { rel: "stylesheet", href: ColorPickerCSS },
  ];
}
